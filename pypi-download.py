...
class HTMLManager:
    ...
    """
    A class only build and manage the HTML files needed for the PyPI local repository. 
    """
    ...
    def insertPackageEntry(self, htmlString: str, pypiLocalPath: str, packageName: str) -> tuple[bool, str]:
        ...
        if soup.find("a", string = packageName): return True, ""
...
def main():
    ...
    if needToDownloadFiles: controllerInstance.downloadFiles()
